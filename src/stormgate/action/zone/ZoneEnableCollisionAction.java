 ...
 * @author David
 */
public class ZoneEnableCollisionAction implements Action
{
	...
	public ZoneEnableCollisionAction(Map map, MapZone[] selected, boolean value)
	{
		this.map = map;
