 ...
 * @author David
 */
public class ZoneEnableSkillBankAction implements Action
{
	...
	public ZoneEnableSkillBankAction(Map map, MapZone[] selected, boolean value)
	{
		this.map = map;
